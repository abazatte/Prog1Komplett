...
public class Spiel {
	...
	public void auswertenSpielzug(int gewuerfelteZahl) {
		...
		// Das aktuelle Guthaben (aktuellesGuthaben) wird aktualisiert in Abhängigkeit
		// davon ob.
		// Schreiben Sie ein Programm, dass die Variable aktuellesGuthaben in
		// Abhängigkeit vom Wert der
	...
	public boolean setWettbetraege(int betragGerade, int betragUngerade) {
		...
		// Das nach Abzug der Einsätze verfügbare Guthaben darf nicht negativ sein. Ist
		// es negativ, liefert die Methode false zurück.
		// sind die Einsätze gültig, so werden wettbetragGerade und wettbetragUngerade
		// auf den gesetzten betrag gesetzt und true zurückgegeben.
		// muss nach Lösen der Aufgabe gelöscht werden.
